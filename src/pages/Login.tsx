        ...
        <form onSubmit={handleSubmit} className="rounded-xl border border-border bg-card p-8 space-y-6">
          <div className="space-y-2">
            ...
            <Input
              id="email"
              type="email"
              placeholder="agent@threatlens.io"
              value={email}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="bg-input border-border text-foreground placeholder:text-muted-foreground focus:ring-primary focus:border-primary pr-10"
                required
              />
              <button
                type="button"
